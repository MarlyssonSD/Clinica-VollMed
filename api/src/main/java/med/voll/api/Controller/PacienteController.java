...
public class PacienteController {
    ...
    @GetMapping
    Page<DadosListarPaciente> listar(@PageableDefault(size = 5, sort = "nome") Pageable paginacao) {
    ...
    @PutMapping
    @Transactional
    public void atualizar(@RequestBody DadosAtualizaPaciente dadosPaciente){
